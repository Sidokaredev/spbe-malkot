...
export default function ArsitekturAplikasi() {
  /* STATE */
  ...
  useEffect(() => {
    const getIndukReferensi = async () => {
      const requestIndukReferensiData: any = await Fetcher(
        "https://spbe-malkot.onrender.com/api/v1/refrensi_arsitektur/4/induk", // REFERENSI ARSITEKRUR STILL STATIC
        {
          method: "GET",
          headers: {
  ...
  return (
    <DashboardAdminLayout>
      ...
      >
              ...
              indukReferensi.map((indukRef, indukRefIndex) => {
                ...
                return (
                  <Box key={indukRefIndex}>
                    <FolderCard
                      folderLevel="1"
                      kodeReferensiArsitektur={"RAA.0" + indukRef.kode}
        ...
        {/* Dialog */}
        <DialogFormBase
          referensiArsitekturId={4} // STATIC
