  ...
  useEffect(() => {
    const getIndukReferensi = async () => {
      const requestIndukReferensiData: any = await Fetcher(
        "https://spbe-malkot.onrender.com/api/v1/refrensi_arsitektur/6/induk", // REFERENSI ARSITEKRUR STILL STATIC
        {
          method: "GET",
          headers: {
  ...
  return (
    <DashboardAdminLayout>
      ...
      >
              ...
              indukReferensi.map((indukRef, indukRefIndex) => {
                ...
                return (
                  <Box key={indukRefIndex}>
                    <FolderCard
                      folderLevel="1"
                      kodeReferensiArsitektur={"RAK.0" + indukRef.kode}
        ...
        {/* Dialog */}
        <DialogFormBase
          referensiArsitekturId={6} // STATIC
