...
import DetailReferensiInfrastruktur from "./DetailReferensi";

export default function SubReferensiInfrastruktur({
  indukReferensi,
  collapseFolder,
  collapseHandler,
}: {
        ...
        return (
          <Box key={subRefIndex}>
            <FolderCard
              ...
              kodeReferensiArsitektur={"RAI.0" + subRef.kode}
