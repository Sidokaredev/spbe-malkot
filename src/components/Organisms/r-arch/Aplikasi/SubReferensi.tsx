...
import DetailReferensiAplikasi from "./DetailReferensi";

export default function SubReferensiAplikasi({
  indukReferensi,
  collapseFolder,
  collapseHandler,
}: {
        ...
        return (
          <Box key={subRefIndex}>
            <FolderCard
              ...
              kodeReferensiArsitektur={"RAA.0" + subRef.kode}
