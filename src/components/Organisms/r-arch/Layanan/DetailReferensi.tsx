...
import ReferensiPenggunaLayanan from "./ReferensiPengguna";

export default function DetailReferensiLayanan({
  indukReferensi,
  subReferensi,
  collapseFolder,
  collapseHandler,
        ...
        return (
          <Box key={detailRefIndex}>
            <FolderCard
              ...
              kodeReferensiArsitektur={"RAL.0" + detailRef.kode}
