...
import ReferensiPenggunaKeamanan from "./ReferensiPengguna";

export default function DetailReferensiKeamanan({
  indukReferensi,
  subReferensi,
  collapseFolder,
  collapseHandler,
        ...
        return (
          <Box key={detailRefIndex}>
            <FolderCard
              ...
              kodeReferensiArsitektur={"RAK.0" + detailRef.kode}
