...
import DetailReferensiKeamanan from "./DetailReferensi";

export default function SubReferensiKeamanan({
  indukReferensi,
  collapseFolder,
  collapseHandler,
}: {
        ...
        return (
          <Box key={subRefIndex}>
            <FolderCard
              ...
              kodeReferensiArsitektur={"RAK.0" + subRef.kode}
