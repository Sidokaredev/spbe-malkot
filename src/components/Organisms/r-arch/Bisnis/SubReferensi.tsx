...
import DetailReferensiBisnis from "./DetailReferensi";

export default function SubReferensiBisnis({
  indukReferensi,
  collapseFolder,
  collapseHandler,
}: {
        ...
        return (
          <Box key={subRefIndex}>
            <FolderCard
              ...
              kodeReferensiArsitektur={"RAB.0" + subRef.kode}
