...
import ReferensiPenggunaData from "./ReferensiPengguna";

export default function DetailReferensiData({
  indukReferensi,
  subReferensi,
  collapseFolder,
  collapseHandler,
        ...
        return (
          <Box key={detailRefIndex}>
            <FolderCard
              ...
              kodeReferensiArsitektur={"RAD.0" + detailRef.kode}
